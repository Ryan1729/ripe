...
fn generate_with_exit_at_index(
    ...
    maze::via_backtracking(proto_tiles, rng, proto_width, XY::default());
...
mod to_one_thick_connects_all_cells_on {
    use super::*;
    use maze::via_backtracking_connects_all_cells_on::are_all_cells_connected as are_all_proto_cells_connected;
